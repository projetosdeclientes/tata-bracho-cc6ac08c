...
function Inicio() {
  ...
  return (
    <>
      ...
      <section
        ref={valoresLayers}
        className="bg-navy relative z-10 -mt-6 overflow-hidden rounded-t-[2rem] pt-28 pb-20 shadow-[0_-40px_80px_-20px_rgba(1,21,85,0.95)] sm:-mt-24 sm:pt-36 sm:pb-28 lg:-mt-[20vh]"
      >
